...
func (_m *MockEncoder) Encode(r ...ocr2keepers.CheckResult) ([]byte, error) {
...
func (_m *MockEncoder) Extract(b []byte) ([]ocr2keepers.ReportedUpkeep, error) {
	ret := _m.Mock.Called(b)

	var r0 []ocr2keepers.ReportedUpkeep
	if rf, ok := ret.Get(0).(func() []ocr2keepers.ReportedUpkeep); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
