...
// Client is a mock type for the Client type
type Client struct {
	mock.Mock
}
...
func (_m *Client) GetEthBalance(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
	ret := _m.Called(ctx, account, blockNumber)
...
func (_m *Client) HeadByNumber(ctx context.Context, n *big.Int) (*types.Header, error) {
	ret := _m.Called(ctx, n)
