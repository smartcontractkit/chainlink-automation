...
func BenchmarkReport(b *testing.B) {
	...
	key2 := chain.UpkeepKey("1|2")
	key3 := chain.UpkeepKey("2|1")
	data := []byte("abcd")
...
func mustEncodeUpkeepObservation(o *chain.UpkeepObservation) []byte {
	b, _ := encode(o)
	return b
}
