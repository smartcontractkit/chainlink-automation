	...
	tests := []struct {
		...
		},
		{
			...
			ExpectedObservation: types.Observation(mustEncodeKeys([]ktypes.UpkeepKey{
				...
				[]byte("100000000000100000000000100000000000100000000000100000000001|100000000000100000000000100000000000100000000007"),
				[]byte("100000000000100000000000100000000000100000000000100000000001|100000000000100000000000100000000000100000000008"),
				[]byte("100000000000100000000000100000000000100000000000100000000001|100000000000100000000000100000000000100000000009"),
			})),
		},
	}
	...
	tests := []struct {
		...
		},
		{
			...
			Checks: []struct {
				...
				{K: ktypes.UpkeepKey([]byte("1|1")), R: ktypes.UpkeepResult{State: ktypes.NotEligible, PerformData: []byte("abcd")}},
				{K: ktypes.UpkeepKey([]byte("1|2")), R: ktypes.UpkeepResult{State: ktypes.NotEligible, PerformData: []byte("abcd")}},
			},
			ExpectedBool: false,
		},
		{
