...
func TestWorker(t *testing.T) {
	...
	//
	//	res := []automation.CheckResult{"1"}
	//
	//	f := func(_ context.Context) ([]automation.CheckResult, error) {
...
func TestWorkerGroup(t *testing.T) {
	...
	//
	//	for n := 0; n < 10; n++ {
	//		err := wg.Do(ctx, func(c context.Context) ([]automation.CheckResult, error) {
	//			return []automation.CheckResult{"1"}, nil
	//		}, group)
	//		if err != nil {
	//			t.FailNow()
	//		}
	...
	//		err := wg.Do(ctx, func(_ context.Context) ([]automation.CheckResult, error) {
	//			return []automation.CheckResult{"1"}, nil
	//		}, gp)
	//
	//		errs <- err
	...
	//
	//	go func(errs chan error, gp int) {
	//		err := wg.Do(context.Background(), func(_ context.Context) ([]automation.CheckResult, error) {
	//			return []automation.CheckResult{"1"}, nil
	//		}, gp)
	//
	//		errs <- err
	...
	//
	//	go func(gp int) {
	//		err := wg.Do(context.Background(), func(ctx context.Context) ([]automation.CheckResult, error) {
	//			tmr := time.NewTimer(100 * time.Millisecond)
	//			select {
	//			case <-ctx.Done():
	//				tmr.Stop()
	//				return []automation.CheckResult{"0"}, fmt.Errorf("error")
	//			case <-tmr.C:
	//				return []automation.CheckResult{"1"}, nil
	//			}
	//		}, gp)
	...
	//			assert.Equal(t, []automation.CheckResult{"0"}, r.Data, "data from work result should match")
	...
	//	testAdd := func() error {
	//		return wg.Do(context.Background(), func(ctx context.Context) ([]automation.CheckResult, error) {
	//			return []automation.CheckResult{"0"}, nil
	//		}, group)
	//	}
	//
