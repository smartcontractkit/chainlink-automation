...
func (_m *MockPayloadBuilder) BuildPayload(_a0 context.Context, _a1 ocr2keepers.CoordinatedProposal) (ocr2keepers.UpkeepPayload, error) {
	ret := _m.Called(_a0, _a1)

	var r0 ocr2keepers.UpkeepPayload
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ocr2keepers.CoordinatedProposal) (ocr2keepers.UpkeepPayload, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ocr2keepers.CoordinatedProposal) ocr2keepers.UpkeepPayload); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(ocr2keepers.UpkeepPayload)
	}

	if rf, ok := ret.Get(1).(func(context.Context, ocr2keepers.CoordinatedProposal) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
