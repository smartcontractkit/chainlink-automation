...
func (_m *MockResultStore) Remove(_a0 ...ocr2keepers.CheckResult) {
	_va := make([]interface{}, len(_a0))
	for _i := range _a0 {
		_va[_i] = _a0[_i]
	}
...
func (_m *MockResultStore) View() ([]ocr2keepers.CheckResult, error) {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() []ocr2keepers.CheckResult); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
