...
// GetLogs provides a mock function with given fields: _a0
func (_m *MockLogEventProvider) GetLogs(_a0 context.Context) ([]ocr2keepers.UpkeepPayload, error) {
	ret := _m.Called(_a0)

	var r0 []ocr2keepers.UpkeepPayload
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]ocr2keepers.UpkeepPayload, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []ocr2keepers.UpkeepPayload); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
