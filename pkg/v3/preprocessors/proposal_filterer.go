...
func NewProposalFilterer(metadata types.MetadataStore, upkeepType types.UpkeepType) ocr2keepersv3.PreProcessor {
...
var _ ocr2keepersv3.PreProcessor = (*proposalFilterer)(nil)
