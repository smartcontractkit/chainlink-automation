...
type Registry interface {
	CheckUpkeep(context.Context, ...ocr2keepers.UpkeepKey) ([]ocr2keepers.UpkeepResult, error)
}
...
func (o *Executer) CheckUpkeep(ctx context.Context, keys ...ocr2keepers.UpkeepKey) ([]ocr2keepers.UpkeepResult, error) {
	r, err := o.parallelCheck(ctx, keys)
	if err != nil {
		return nil, err
	}
...
func (o *Executer) parallelCheck(ctx context.Context, keys []ocr2keepers.UpkeepKey) (*Result, error) {
	result := NewResult()
...
func (o *Executer) wrapWorkerFunc() func(context.Context, []ocr2keepers.UpkeepKey) ([]ocr2keepers.UpkeepResult, error) {
	return func(ctx context.Context, keys []ocr2keepers.UpkeepKey) ([]ocr2keepers.UpkeepResult, error) {
		...
		checkResults, err := o.reg.CheckUpkeep(ctx, keys...)
		if err != nil {
